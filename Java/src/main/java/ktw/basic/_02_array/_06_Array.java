...
public class _06_Array {
    public static void main(String[] args) {
        _06_Array a06Array = new _06_Array();
        ...
        for (int number : a06Array.solution2(numArray)) {
            System.out.print(number + " ");
        }
    }

    private ArrayList<Integer> solution(int[] numArray) {
        ArrayList<Integer> answer = new ArrayList<>();
        for (int number : numArray) {
            String string = String.valueOf(number);
            String reverseString = new StringBuilder(string).reverse().toString();
            int reverseNumber = Integer.parseInt(reverseString);
            if (reverseNumber == 1) continue;
            boolean flag = true;
    ...
    private ArrayList<Integer> solution2(int[] numArray) {
        ArrayList<Integer> answer = new ArrayList<>();
